...
public class Reference
{
    ...
    public static final String NAME = "Custom Enchanting";

    // Internal mod name used for reference purposes and resource gathering.
    public static final String ID = "customenchanting";
    ...
    public static final String COMMON_PROXY = "customenchanting.proxy.CommonProxy";
    public static final String CLIENT_PROXY = "customenchanting.proxy.ClientProxy";
}
